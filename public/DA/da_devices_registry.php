...
class da_devices_registry {
    ...
    public static function GetListOfDevices($account_id) {
        ...
        $stmt->bind_result(
                ...
                $deviceEntry->account_id,
                $deviceEntry->device_nickname,
                $deviceEntry->device_description,
                $deviceEntry->api_key,
                $deviceEntry->created_datetime,
                $deviceEntry->modified_datetime,
                $deviceEntry->deleted_datetime,
                $deviceEntry->last_connected_datetime);
